import { signInWithEmail } from '@/services/firebase/firebaseAuth';
...
export default function SignIn() {
  ...
  return (
    <View style={{ flex: 1, padding: 24,justifyContent: 'center', gap: 12, backgroundColor: "#FFF9F5" }}>
      ...
      <Text style={mainStyle.title}>Sign In</Text>
      ...
      >
        {submitting ? <ActivityIndicator /> : <Text style={{ color: 'white', fontWeight: '600' }}>Sign In</Text>}
      </Pressable>

      <Link href="./signUp" style={mainStyle.link}>Sign Up</Link>
    </View>
  );
}
